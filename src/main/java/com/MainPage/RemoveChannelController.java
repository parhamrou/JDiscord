...
public class RemoveChannelController implements Initializable {
    ...
    private void addChannelCell(String channelName) {
        ...
        button.setOnMouseClicked(e -> {
            ServerHandler.getInstance().deleteChannel(channelName);
    ...
    private void setChannels() {
        for (String channelName : ServerHandler.getInstance().getChannels()) {
