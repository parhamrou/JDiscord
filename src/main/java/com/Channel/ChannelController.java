...
public class ChannelController implements  Initializable{
    ...
    void sendButtonPressed(ActionEvent event) throws ClassNotFoundException {
        ...
        ChannelHandler.getInstance().serverWriter(chatTextField.getText(), null);
    ...
    void sendFileButtonPressed(ActionEvent event) {
        ...
        try {
            ChannelHandler.getInstance().serverWriter("#send file", file.getAbsolutePath());
    ...
    public void addMessage(Message message, boolean isMyMessage) {
        ...
        if (message instanceof FileMessage) {
            ...
            downloadButton.setOnMouseClicked(e -> {
                ...
                try {
                    ChannelHandler.getInstance().serverWriter("#download file", message.getText());
    ...
    public void setMessages(ArrayList<Message> messages) {
        channelNameText.setText(ChannelHandler.getInstance().getChannelName());
